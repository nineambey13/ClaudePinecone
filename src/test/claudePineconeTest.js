...
// Test Claude's ability to use Pinecone knowledge
...
// Run the test
testClaudePineconeIntegration().then(success => {
  if (success) {
    console.log('\n✅ Claude-Pinecone integration test completed!');
  } else {
    console.log('\n❌ Claude-Pinecone integration test failed. Please check the logs above.');
  }
});
